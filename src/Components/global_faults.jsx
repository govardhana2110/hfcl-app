...
class GlobalFault extends React.Component {
  ...
  filter_alarms() {
    const { selectedOptions ,get_globalfault ,get_global_active_alarms, showActive, showHistory, checkedColumns,tableHeaders} = this.state;
    ...
    console.log(selectedOptions, this.state.setFlag);
  ...
  updateWithSearchTerm(searchTerm) {
    ...
    if (!searchTerm) {
      this.setState({ get_filtered_alarms: get_globalfault });
    } else {
  ...
  renderSeverityOptions() {
    const severityOptions = [
      ...
      { severity: "RESET", image: require('../Images/reset-password.png') } 
    ];
    ...
    return severityOptions.map((option, index) => (
      <div key={index} style={{ display: "inline-block", margin:"0% 2.5%" }}>
        <div style={option.style} onClick={() => this.sortTableWithSeverity(option.severity, option.severity === "RESET")}>
          {option.severity === "RESET" ? <img src={option.image} alt=""  width="20"/> : `${option.severity}:`}
            ...
            <div style={{ display: "flex" }}>
              <div style={{ flex: "4" }}>
                ...
                <div
                  ...
                  style={{ marginLeft: "3%", marginTop: "9%", width: "94%" }}
                >
                  <section
                  ...
                  >
                    ...
                    <span style={{ display: "flex", marginLeft: "11rem" }}>
                      <div
                        className="tabbox"
                        style={
